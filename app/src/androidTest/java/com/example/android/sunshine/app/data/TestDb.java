...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue(" No row returned for LocationEntry table test", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord(" Content of LocationEntry table not validated", cursor, values);
    ...
    public void testWeatherTable() {
        ...
        assertTrue("WeatherEntry table record present", cursor.moveToFirst());

        TestUtilities.validateCursor("Weather entry values not valid", cursor, weatherValues);
