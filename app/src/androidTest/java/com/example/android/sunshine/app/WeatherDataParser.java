...
public class WeatherDataParser extends TestCase {

    private static String MAX_TEMP = "max";
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex)
        ...
        if (jsonArray.length() > dayIndex) {
            JSONObject dayDetails = jsonArray.getJSONObject(dayIndex);
            JSONObject temperature = dayDetails.getJSONObject(TEMP_TAG);
            return temperature.getDouble(MAX_TEMP);
        }
